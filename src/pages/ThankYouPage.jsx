...
const ThankYouPage = () => {
  ...
  const parseUrlParams = () => {
    ...
    // Extract tenant from path: /:tenant/ThankYou
  ...
  const loadTenantData = async () => {
    try {
      ...
      console.log(`🔍 ThankYouPage: Loading tenant data for: ${tenantName} with locale: ${locale}`);
      ...
      console.log('🔧 Setting theme config:', config);
  ...
  const handleBackToLogin = () => {
    ...
    navigate(`/${tenant}/Login?theme=${theme}&locale=${locale}`);
  };
  ...
  if (loading) {
    return (
      <div className={styles.pageContainer}>
        <div className={styles.thankYouSide}>
          <div style={{
            display: 'flex',
  ...
  if (error) {
    return (
      <div className={styles.errorPage}>
        ...
        <button className={styles.retryButton} onClick={loadTenantData}>
          Try Again
        </button>
      </div>
    );
        ...
        <div style={{
          ...
          <div className={styles.thankYouContent}>
            ...
            <div className={styles.message}>
              <p>Thank you for registering your interest in our marketing portal.</p>
              <p>Your account has been created successfully, but access to the full portal requires additional permissions.</p>
              <p>Please contact your administrator to request access to the marketing resources.</p>
            </div>
            ...
            <div className={styles.actionSection}>
              <button 
                ...
                style={{
                  backgroundColor: loginConfig?.primaryColor || '#1976d2',
                  borderColor: loginConfig?.primaryColor || '#1976d2'
                }}
              >
                Back to Login
              </button>
